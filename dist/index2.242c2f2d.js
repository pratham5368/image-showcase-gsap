  ...
  contentItem.DOM.imgWrap.addEventListener('click', () => {
    ...
    _gsap.gsap.timeline({
      ...
      onStart: () => {
        ...
        _gsap.gsap.set(previewItem.DOM.el, {
          clipPath: `circle(0vmax at ${winsize.width / 2}px ${winsize.height / 2}px)`
        });
        _gsap.gsap.set(previewItem.DOM.img, {
          scale: 0.8
        });
        _gsap.gsap.set(previewItem.DOM.title, {
          scale: 1.6
        });
        _gsap.gsap.set(previewItem.DOM.boxes, {
    ...
    }, 'preview').to([previewItem.DOM.img, previewItem.DOM.title], {
      scale: 1
