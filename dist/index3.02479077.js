...
},{"imagesloaded":"../node_modules/imagesloaded/imagesloaded.js"}],"js/contentItem.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/previewItem.js":[function(require,module,exports) {
"use strict";
...
},{"./utils/matrix.js":"../node_modules/gsap/utils/matrix.js"}],"js/index3.js":[function(require,module,exports) {
"use strict";
...
[...document.querySelectorAll('.preview__item')].forEach(previewItem => {
  previewItems.push(new _previewItem.PreviewItem(previewItem));
});

// Content Items
const contentItems = [];
[...document.querySelectorAll('.content__item')].forEach((contentItem, pos) => {
  contentItems.push(new _contentItem.ContentItem(contentItem, previewItems[pos]));
});
...
for (const [pos, contentItem] of contentItems.entries()) {
  ...
  contentItem.DOM.imgWrap.addEventListener('click', () => {
    ...
    _gsap.gsap.timeline({
      ...
      onStart: () => {
        ...
        _gsap.gsap.set(contentItem.DOM.el, {
          zIndex: 10
        });
        _gsap.gsap.set(contentOverlay, {
          transformOrigin: current % 2 ? '0% 100%' : '0% 0%',
          scaleX: contentItem.DOM.el.offsetWidth / winsize.width,
          scaleY: 0,
          x: contentItem.DOM.el.offsetLeft
        });
        _gsap.gsap.set(previewItem.DOM.slideTexts, {
          yPercent: 100
        });
        _gsap.gsap.set(previewItem.DOM.descriptions, {
          xPercent: pos => pos ? -5 : 5,
          opacity: 0
        });
        _gsap.gsap.set(backCtrl, {
          x: '+=15%',
          opacity: 0
        });
      ...
      const flipstate = _Flip.Flip.getState(contentItem.DOM.imgWrap);
      previewItem.DOM.imgOuter.appendChild(contentItem.DOM.imgWrap);
      _Flip.Flip.from(flipstate, {
        duration: 0.8,
        ease: 'power4.inOut',
        absolute: true
      });
  ...
  contentItem.DOM.imgWrap.addEventListener('mouseleave', () => {
    ...
    }).addLabel('start', 0).to([contentItem.DOM.imgWrap, contentItem.DOM.img], {
      scale: 1
    }, 'start');
  });
}
...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js","./contentItem":"js/contentItem.js","./previewItem":"js/previewItem.js","gsap/Flip":"../node_modules/gsap/Flip.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index3.js"], null)
