...
_gsap.gsap.set(contentOverlayInner, {
  xPercent: -100
});
// Preview Items
const previewItems = [];
  ...
  contentItem.DOM.imgWrap.addEventListener('click', () => {
    ...
    _gsap.gsap.timeline({
      ...
      onStart: () => {
        ...
        _gsap.gsap.set(previewItem.DOM.img, {
          xPercent: 100
        });
        _gsap.gsap.set(previewItem.DOM.imgWrap, {
          xPercent: -102,
          opacity: 0
        });
      ...
      xPercent: 0
    }, 'start').to([previewItem.DOM.img, previewItem.DOM.imgWrap], {
      xPercent: 0
...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js","./contentItem":"js/contentItem.js","./previewItem":"js/previewItem.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
